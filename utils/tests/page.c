...
//     page->swap_block = 0;
//     page->page_content = "0000000000000000000000000000000";
...
//     should_string(deserialized_page->page_content) be equal to("0000000000000000000000000000000");
//     free(page);
// }
// end
...
//     page->displacement = 0;
//     page->pid = 0;
//     page->register_value = "0000000000000000000000000000000";
//     page->size = 32;
...
//     should_string(deserialized_page->register_value) be equal to("0000000000000000000000000000000");
